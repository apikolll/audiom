...
<div class="text-center text-light mb-3">
    <h3 class="display-3 fw-bold">Reschedule Appointment</h3>
</div>
...
<section class="pt-5">
    <div class="container">
        ...
        <section class="p-5 text-dark fs-5 shadow-lg bg-light border border-dark rounded-4 border-opacity-10 fs-6">
            <form action={{ route('app-patient.updateReschedule', $app->id) }} enctype="multipart/form-data" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <div class="card rounded-3 p-4 border border-danger">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="{{ $session->id }}"
                                            id="flexRadioDefault1" name="session" {{ $session->id == $app->session_id ? 'checked' : '' }} >
                                ...
                                <div class="col-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="cabin" value=1
                                            id="flexRadioDefault1" {{ $app->cabin == 1 ? 'checked' : '' }}>
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            Cabin 1
                                        </label>
                                    </div>
                                ...
                                <div class="col-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="cabin" value=2
                                            id="flexRadioDefault1" {{ $app->cabin == 2 ? 'checked' : '' }}>
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            Cabin 2
                                        </label>
                                    </div>
                                ...
                                <div class="col-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="cabin" value=3
                                            id="flexRadioDefault1" {{ $app->cabin == 3 ? 'checked' : '' }}>
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            Cabin 3
                                        </label>
                                    </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description" readonly>{{ $app->description }}</textarea>
                </div>
                <div class="text-center mt-5">
                    <button type="submit" class="btn btn-outline-primary px-4">Reschedule</button>
