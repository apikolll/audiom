        ...
        <div class="d-flex text-center justify-content-center">
            <div class="d-block">
                <a href="#" class="text-decoration-none">
                    <h4 class="text-center display-5"><span class="fw-light text-light"> Let's make your life
        ...
        <div class="d-md-flex justify-content-evenly">
            <div class="d-block mb-3">
                ...
                <div class="mt-4 d-flex gap-5 justify-content-center align-items-center">
                    <a href="#" class="text-light"><i class="h3 bi bi-twitter"></i></a>
                    <a href="#" class="text-light"><i class="h3 bi bi-instagram"></i></a>
                    <a href="{{ URL('https://www.facebook.com/KAHSIIUM/?ref=bookmarks') }}" class="text-light"><i class="h3 bi bi-facebook"></i></a>
                </div>
            </div>
            <div class="d-block mb-3">
                <h3 class="text-center">Contact us</h3>
                <p><i class="bi bi-house"></i> International Islamic University Malaysia</p>
                <p><i class="bi bi-envelope"></i> dean_kahs@iium.edu.my</p>
